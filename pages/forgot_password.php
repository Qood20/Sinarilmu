<?php
// pages/forgot_password.php - Halaman untuk meminta reset password
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email)) {
        ...
        if ($result) {
            $success = "Jika email yang Anda masukkan terdaftar di sistem kami, kami telah mengirimkan tautan reset password ke email tersebut. Silakan cek kotak masuk Anda.";
        } else {
            $error = "Terjadi kesalahan saat mengirimkan tautan reset password. Silakan coba lagi.";
        }
    }
}
?>
        ...
        <div class="bg-white p-10 rounded-2xl shadow-xl relative">
            <div class="text-center mb-8 animate-fade-in-down">
                ...
                <p class="mt-2 text-sm text-gray-600 animate-fade-in-up delay-500">
                    Masukkan email Anda dan kami akan kirimkan tautan untuk mereset kata sandi
                </p>
            </div>
            ...
            <form class="mt-8 space-y-6 animate-fade-in-up delay-500" action="" method="post">
            ...
            <div class="mt-6 text-center animate-fade-in-up delay-700">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="?page=login" class="font-bold text-blue-600 hover:text-blue-500">Masuk di sini</a>
                </p>
            </div>
        </div>
