<?php
// dashboard/pages/upload.php - Halaman unggah file dan analisis AI
...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        // Debug: show if session variables exist but aren't displayed
        if (isset($_SESSION['error']) || isset($_SESSION['success'])) {
            echo '<!-- Session variables exist but not displayed properly -->';
        }
        ?>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                                    <?php
                                    echo $file['status'] === 'completed' ? 'bg-green-100 text-green-800' :
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <a href="<?php echo escape($file['file_path']); ?>" target="_blank" class="text-blue-600 hover:text-blue-900">Lihat</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
