...
<div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg p-8">
        <div class="flex items-center mb-6">
            <a href="?page=materi_kelas11" class="text-yellow-600 hover:text-yellow-800 flex items-center">
        ...
        try {
            $stmt = $pdo->prepare("
                ...
                WHERE m.kelas = '11' AND m.mata_pelajaran = 'biologi' AND m.status = 'aktif'
