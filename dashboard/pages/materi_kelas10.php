<?php
// dashboard/pages/materi_kelas10.php - Halaman utama materi kelas 10
...
<div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <h2 class="text-3xl font-bold text-gray-800 mb-2">Materi Kelas 10</h2>
        <p class="text-gray-600 mb-8">Pilih mata pelajaran untuk kelas 10 SMA</p>
        ...
        <!-- Tampilkan materi dari admin berdasarkan kelas 10 -->
        <?php
        global $pdo;
        try {
            $stmt = $pdo->prepare("
                ...
                WHERE m.kelas = '10' AND m.status = 'aktif'
                ORDER BY m.mata_pelajaran, m.sub_topik, m.created_at DESC
            ");
            $stmt->execute();
            $admin_materials = $stmt->fetchAll();
        } catch (Exception $e) {
            error_log("Error getting admin materials for class 10: " . $e->getMessage());
            $admin_materials = [];
        }
        ...
        ?>
        <div class="mt-10">
            <h3 class="text-2xl font-bold text-gray-800 mb-4">Materi dari Admin untuk Kelas 10</h3>
        ...
        <div class="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
            ...
            <ul class="list-disc pl-5 text-blue-700 space-y-2">
                <li>Pelajari materi secara bertahap sesuai dengan kurikulum kelas 10</li>
