...
<div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg p-8">
        <div class="flex items-center mb-6">
            <a href="?page=analisis_materi" class="text-green-600 hover:text-green-800 flex items-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                        ...
                        <div class="mt-3 flex justify-between items-center">
                            <a href="<?php echo $material['file_path']; ?>" target="_blank" class="text-green-600 hover:text-green-800 text-sm font-medium flex items-center">
