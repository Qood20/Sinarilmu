<?php
// dashboard/pages/kimia_kelas12.php - Halaman materi kimia kelas 12
...
<div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg p-8">
        <div class="flex items-center mb-6">
            <a href="?page=materi_kelas12" class="text-purple-600 hover:text-purple-800 flex items-center">
        ...
        <h2 class="text-3xl font-bold text-gray-800 mb-2">Kimia Kelas 12</h2>
        <p class="text-gray-600 mb-8">Materi pelajaran kimia untuk kelas 12 SMA</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Sifat Koligatif Larutan</h3>
                <p class="text-gray-600 mb-4">Penurunan tekanan uap, kenaikan titik didih, dan penurunan titik beku</p>
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Reaksi Redoks dan Elektrokimia</h3>
                <p class="text-gray-600 mb-4">Reaksi reduksi oksidasi dan sel elektrokimia</p>
                <a href="#" class="text-purple-600 hover:text-purple-800 font-medium inline-flex items-center">
                    Pelajari Sekarang
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Kimia Unsur</h3>
                <p class="text-gray-600 mb-4">Unsur-unsur penting dan senyawa yang dibentuknya</p>
                <a href="#" class="text-purple-600 hover:text-purple-800 font-medium inline-flex items-center">
                    Pelajari Sekarang
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Termokimia</h3>
                <p class="text-gray-600 mb-4">Perubahan entalpi dan hukum Hess</p>
                <a href="#" class="text-purple-600 hover:text-purple-800 font-medium inline-flex items-center">
                    Pelajari Sekarang
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Senyawa Hidrokarbon</h3>
                <p class="text-gray-600 mb-4">Alkana, alkena, alkuna, dan senyawa aromatik</p>
                <a href="#" class="text-purple-600 hover:text-purple-800 font-medium inline-flex items-center">
                    Pelajari Sekarang
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Makromolekul</h3>
                <p class="text-gray-600 mb-4">Karbohidrat, protein, lemak, dan polimer</p>
                <a href="#" class="text-purple-600 hover:text-purple-800 font-medium inline-flex items-center">
                    Pelajari Sekarang
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        ...
        try {
            $stmt = $pdo->prepare("
                ...
                WHERE m.kelas = '12' AND m.mata_pelajaran = 'kimia' AND m.status = 'aktif'
