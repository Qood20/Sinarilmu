<?php
// dashboard/pages/biologi_kelas12.php - Halaman materi biologi kelas 12
...
<div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg p-8">
        <div class="flex items-center mb-6">
            <a href="?page=materi_kelas12" class="text-yellow-600 hover:text-yellow-800 flex items-center">
        ...
        <h2 class="text-3xl font-bold text-gray-800 mb-2">Biologi Kelas 12</h2>
        <p class="text-gray-600 mb-8">Materi pelajaran biologi untuk kelas 12 SMA</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Biotechnology</h3>
                <p class="text-gray-600 mb-4">Konsep dan aplikasi bioteknologi dalam kehidupan sehari-hari</p>
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Evolusi</h3>
                <p class="text-gray-600 mb-4">Teori evolusi dan bukti-bukti evolusi</p>
                <a href="#" class="text-yellow-600 hover:text-yellow-800 font-medium inline-flex items-center">
                    Pelajari Sekarang
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Ekologi dan Lingkungan</h3>
                <p class="text-gray-600 mb-4">Interaksi organisme dan lingkungan serta masalah lingkungan</p>
                <a href="#" class="text-yellow-600 hover:text-yellow-800 font-medium inline-flex items-center">
                    Pelajari Sekarang
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Genetika dan Pewarisan Sifat</h3>
                <p class="text-gray-600 mb-4">Hukum Mendel, peta silang, dan pewarisan sifat</p>
                <a href="#" class="text-yellow-600 hover:text-yellow-800 font-medium inline-flex items-center">
                    Pelajari Sekarang
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Bioteknologi Modern</h3>
                <p class="text-gray-600 mb-4">DNA rekombinan, PCR, dan teknologi genom</p>
                <a href="#" class="text-yellow-600 hover:text-yellow-800 font-medium inline-flex items-center">
                    Pelajari Sekarang
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            ...
            <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Konservasi dan Biodiversitas</h3>
                <p class="text-gray-600 mb-4">Pelestarian keanekaragaman hayati dan ekosistem</p>
                <a href="#" class="text-yellow-600 hover:text-yellow-800 font-medium inline-flex items-center">
                    Pelajari Sekarang
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        ...
        try {
            $stmt = $pdo->prepare("
                ...
                WHERE m.kelas = '12' AND m.mata_pelajaran = 'biologi' AND m.status = 'aktif'
